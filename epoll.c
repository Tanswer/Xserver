...
void mm_epoll_add(int epfd, int fd, struct epoll_event* event)
{
...
void mm_epoll_mod(int epfd, int fd, struct epoll_event *event)
{
...
void mm_epoll_del(int epfd, int fd, struct epoll_event *event)
{
...
int mm_epoll_wait(int epfd, struct epoll_event *events, int maxevents, int timeout)
{
