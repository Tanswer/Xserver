...
void xm_epoll_add(int epfd, int fd, struct epoll_event* event)
{
...
void xm_epoll_mod(int epfd, int fd, struct epoll_event *event)
{
...
void xm_epoll_del(int epfd, int fd, struct epoll_event *event)
{
...
int xm_epoll_wait(int epfd, struct epoll_event *events, int maxevents, int timeout)
{
